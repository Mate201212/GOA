Check if a people loves you or people hates you
num = 10
if num > 0:
    print("people loves me.")
else:
    print("people hates me.")
...
# 7. Check if a person is a teenager
age = 15
...
# 8. Determine if a number is divisible by both 3 and 5
num = 30
